...
pub(crate) struct UnwrappedCache {
    cache: RwLock<LruCache<String, KResult<CachedUnwrappedObject>>>,
}
...
impl UnwrappedCache {
    ...
    /// Peek into the cache
    pub(crate) async fn peek(&self, uid: &str) -> Option<KResult<CachedUnwrappedObject>> {
    ...
    pub(crate) async fn insert(
        &self,
        uid: String,
        unwrapped_object: KResult<CachedUnwrappedObject>,
    ) {
    ...
    pub(crate) async fn get_cache(
        &self,
    ) -> RwLockReadGuard<'_, LruCache<String, KResult<CachedUnwrappedObject>>> {
